  ...
  return (
    <Container fluid className=" bg-white w-100 pb-5 bg-contattaci-header">
      <Row className="text-center">
        <Col xs={12} className=" my-5 bg-white bg-opacity-75">
      ...
      <Row>
        <Col
          xs={12}
          lg={5}
          className=" text-white text-center fw-bold fs-3 informazioniContatto pt-3 ms-lg-5"
        >
          <p className=" display-6 fw-bolder text-uppercase ">
          ...
          <p>
            <strong>Indirizzo:</strong> Via del Giappone 88, 00100 Roma, Italia
          </p>
          <p>
